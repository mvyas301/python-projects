...
class Student:
    ...
    def __init__(self,root):
       ...
       pb.studentData()
       def iExit():
              iExit=tkinter.messagebox.askyesno("MIMANSA STUDENT DBMS","confirm if you want to exit")
              if iExit>0:
                     root.destroy()
                     return
       def clearData():
       ...
       self.lblTit=Label(TitFrame,font=('arial',25,'bold'),text="IT VEDANT",bg="red",fg="black")
       self.lblTit.grid()

       self.lblTit=Label(TitFrame,font=('arial',12),text="(DEOCDE YOUR DREAMS)",bg="red",fg="black")
       self.lblTit.grid()
